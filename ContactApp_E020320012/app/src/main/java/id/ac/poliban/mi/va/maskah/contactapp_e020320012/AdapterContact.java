package id.ac.poliban.mi.va.maskah.contactapp_e020320012;
...
public class AdapterContact extends RecyclerView.Adapter<AdapterContact.ContactViewHolder> {
    ...
    private ArrayList<id.ac.poliban.mi.va.maskah.contactapp_e020320012.ModelContact> contactList;
    private id.ac.poliban.mi.va.maskah.contactapp_e020320012.DbHelper dbHelper;

    // add constructor
    // alt + ins

    public AdapterContact(Context context, ArrayList<id.ac.poliban.mi.va.maskah.contactapp_e020320012.ModelContact> contactList) {
        this.context = context;
        this.contactList = contactList;
        dbHelper = new id.ac.poliban.mi.va.maskah.contactapp_e020320012.DbHelper(context);
    }
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        id.ac.poliban.mi.va.maskah.contactapp_e020320012.ModelContact modelContact = contactList.get(position);
        ...
        holder.contactEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, id.ac.poliban.mi.va.maskah.contactapp_e020320012.AddEditContact.class);
        ...
        holder.contactDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((id.ac.poliban.mi.va.maskah.contactapp_e020320012.MainActivity)context).onResume();
